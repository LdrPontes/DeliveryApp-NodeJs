...
var ReadEnterpriseByCodeUseCase_1 = require("../../domain/usecases/order/ReadEnterpriseByCodeUseCase");
var OrderController = /** @class */ (function () {
    function OrderController() {
        this.readEnterpriseByCodeUseCase = new ReadEnterpriseByCodeUseCase_1.ReadEnterpriseByCodeUseCase();
    }
    OrderController.prototype.readEnterpriseByCode = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, code, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.readEnterpriseByCodeUseCase.execute(new ReadEnterpriseByCodeUseCase_1.ReadEnterpriseByCodeParams(code))];
                    case 2: return [4 /*yield*/, (_a.sent()).enterprise];
                    case 3:
                        result = _a.sent();
