...
var SaveProductSectionUseCase_1 = require("../../domain/usecases/productSection/SaveProductSectionUseCase");
var ReadProductSectionUseCase_1 = require("../../domain/usecases/productSection/ReadProductSectionUseCase");
var UpdateProductSectionUseCase_1 = require("../../domain/usecases/productSection/UpdateProductSectionUseCase");
var DeleteProductSectionUseCase_1 = require("../../domain/usecases/productSection/DeleteProductSectionUseCase");
...
var ProductSectionController = /** @class */ (function () {
    function ProductSectionController() {
        this.saveProductSectionUseCase = new SaveProductSectionUseCase_1.SaveProductSectionUseCase();
        this.readProductSectionUseCase = new ReadProductSectionUseCase_1.ReadProductSectionUseCase();
        this.updateProductSectionUseCase = new UpdateProductSectionUseCase_1.UpdateProductSectionUseCase();
        this.deleteProductSectionUseCase = new DeleteProductSectionUseCase_1.DeleteProductSectionUseCase();
    }
    ProductSectionController.prototype.save = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, _a, name, enterprise_id, section, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = req.body, name = _a.name, enterprise_id = _a.enterprise_id;
                        return [4 /*yield*/, this.saveProductSectionUseCase.execute(new SaveProductSectionUseCase_1.SaveProductSectionParams(name, enterprise_id))];
                    case 2:
    ...
    ProductSectionController.prototype.read = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.readProductSectionUseCase.execute(new ReadProductSectionUseCase_1.ReadProductSectionParams(Number(id), search))];
                    case 2:
    ...
    ProductSectionController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, _a, id, name, section, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.updateProductSectionUseCase.execute(new UpdateProductSectionUseCase_1.UpdateProductSectionParams(id, name))];
                    case 2:
                        section = (_b.sent()).section;
                        return [2 /*return*/, res.json(section)];
                    case 3:
    ...
    ProductSectionController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        id = req.params.id;
                        return [4 /*yield*/, this.deleteProductSectionUseCase.execute(new DeleteProductSectionUseCase_1.DeleteProductSectionParams(Number(id)))];
                    case 2:
...
var productSectionController = new ProductSectionController();
exports.default = productSectionController;
//# sourceMappingURL=ProductSectionController.js.map