...
var ReadAllCategoryUseCase_1 = require("../../domain/usecases/category/ReadAllCategoryUseCase");
...
var CategoryController = /** @class */ (function () {
    function CategoryController() {
        this.readAllCategoryUseCase = new ReadAllCategoryUseCase_1.ReadAllCategoryUseCase();
    }
    CategoryController.prototype.readAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.readAllCategoryUseCase.execute()];
                    case 1: return [4 /*yield*/, (_a.sent()).categories];
                    case 2:
                        result = _a.sent();
                        res.json(result);
                        return [3 /*break*/, 4];
